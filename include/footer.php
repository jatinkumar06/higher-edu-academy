      ...
      <div class="col-lg-5 col-md-6 footer-about">
        ...
        <div class="footer-contact pt-3">
          ...
          <p class="mt-3" style="font-weight: bold;">
            <i class="fa-solid fa-phone fa-lg" style="color: black;"></i>
            <a href="tel:+919861953662" style="color: black; text-decoration: none; font-size: 16px;">
              9861953662
            </a>
          </p>
