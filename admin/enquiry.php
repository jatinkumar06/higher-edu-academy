                    ...
                    <div class="card shadow-sm">
                        <div class="card-body">
                            ...
                            <div class="table-responsive">
                                <h2 class="text-center mb-4">ENQUIRY</h2>
                                                ...
                                                <td>
                                                    <?php if ($row['status'] == 0): ?>
                                                        <a href="mark_read.php?id=<?= $row['id'] ?>" class="btn btn-sm btn-info"
                                                            onclick="return confirm('Mark this enquiry as read ?')">Mark as Read</a>
                                                    <?php endif; ?>
                                                    <a href="deleteenquiry.php?id=<?= $row['id'] ?>" class="btn btn-sm btn-danger"
