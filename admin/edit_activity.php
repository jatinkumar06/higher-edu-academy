...
if (isset($_POST['upload'])) {
    ...
    $sql = "UPDATE `activities` SET `activities_name`='$activities_name',`title_image`='$front_path',`content`='$content',`images`='$json_paths' WHERE id='$ID'";
    ...
    if ($conn->query($sql)) {
            echo "<script>alert('Activity Updated Successfully!'); window.location='activity.php';</script>";
...
<div class="d-flex justify-content-center align-items-center mt-5" style="min-height: 75vh;">
    <div class="container">
        <div class="card shadow p-4" style="max-width: 600px; margin:auto;">
            <h3 class="text-center text-primary mb-3">EDIT ACTIVITIES</h3>

            <form action="" method="POST" enctype="multipart/form-data">
                <div class="mb-3">
                    <label class="form-label">Activities Name</label>
                    <input type="text" name="actvities_name" class="form-control" value="<?php echo $data['activities_name'] ?>" required>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <textarea id="insurance_details" class="form-control" name="content"><?php echo $data['content']; ?></textarea>
                </div>
