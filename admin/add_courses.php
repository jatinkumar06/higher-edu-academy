...
if (isset($_POST['upload'])) {
    ...
    $sql = "INSERT INTO `courses`(`name`, `image`, `content`) 
            VALUES ('$activities_name', '$front_path', '$content')";

    if ($conn->query($sql)) {
                   echo "<script>alert('Activity Added Successfully!'); window.location='courses.php';</script>";
...
<div class="d-flex justify-content-center align-items-center mt-5" style="min-height: 75vh;">
    <div class="container">
        <div class="card shadow p-4" style="max-width: 600px; margin:auto;">
            <h3 class="text-center text-primary mb-3">ADD COURSES</h3>
