...
<style>
  ...
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .college-header__text { flex: 1; min-width: 0; }

  .college-header__title {
    font-family: 'Cormorant Garamond', serif;
  ...
  .college-header__title em {
    font-style: italic;
    color: var(--gold-lt);
  }

  /* ✅ College type badge in header */
  .college-header__badge {
    flex-shrink: 0;
    ...
    border-radius: 2px;
    margin-right: .5rem;
    animation: fadeDown .7s .5s both ease;
  }
  ...
  .college-details p {
    ...
    line-height: 1.9; color: #3a3830;
    margin-bottom: 1.6rem;
    text-align: justify; hyphens: auto;
    animation: fadeUp .5s both ease;
  }
  .college-details p:nth-child(1) { animation-delay: .8s; }
  .college-details p:nth-child(2) { animation-delay: .9s; }
  .college-details p:nth-child(3) { animation-delay: 1s; }
  .college-details p:nth-child(n+4) { animation-delay: 1.1s; }

  .college-details p:first-child::first-letter {
    font-family: 'Cormorant Garamond', serif;
    font-size: 4.2em; font-weight: 600;
    color: var(--gold); float: left;
    line-height: .78; margin: .06em .14em 0 0;
  }

  .college-footer-strip {
  ...
  .btn-back:hover { background: var(--gold); color: var(--paper); }
  ...
  .btn-enquiry:hover { opacity: .88; transform: translateY(-1px); }
  ...
  .enquiry-modal .form-control { border-radius: 10px; padding: 10px 14px; }
  ...
  .wa-float:hover .wa-float__label { opacity: 1; transform: translateY(0); }
  ...
  @media (max-width: 768px) {
    .college-hero      { max-height: 260px; }
    .college-hero__img { height: 260px; }
  }
  @media (max-width: 600px) {
    .college-header { gap: 1rem; }
    .college-header__badge { display: none; }
    .college-details p:first-child::first-letter { font-size: 3.2em; }
    .wa-float { right: 1rem; bottom: 1.5rem; }
    .wa-float__btn { width: 52px; height: 52px; }
    .college-hero      { max-height: 220px; }
    .college-hero__img { height: 220px; }
  }
</style>
...
<div class="college-page">
  ...
  <!-- HEADING — logo + name + type badge -->
  <div class="college-header">
    <!-- <div class="college-header__wm"><?php echo htmlspecialchars($data['college_name']); ?></div> -->

    <?php if (!empty($data['logo'])): ?>
      <img
        src="admin/uploads/<?php echo htmlspecialchars($data['logo']); ?>"
        alt="Logo"
        class="college-header__logo">
    <?php endif; ?>

    <div class="college-header__text">
      <h1 class="college-header__title">
        <?php
          $name  = htmlspecialchars($data['college_name']);
          $parts = explode(' ', $name);
    ...
    <!-- ✅ College type badge — unique to college page -->
    <?php if (!empty($data['college_type'])): ?>
      <span class="college-header__badge">
        <?php echo htmlspecialchars($data['college_type']); ?>
      </span>
    <?php endif; ?>
  </div>
  ...
  <div class="college-hero">
    <img
      src="admin/uploads/<?php echo htmlspecialchars($data['college_photo']); ?>"
      class="college-hero__img"
      alt="<?php echo htmlspecialchars($data['college_name']); ?>">
  </div>

  <!-- BODY -->
  <div class="college-body">

    <div class="deco-rule"><div class="deco-rule__diamond"></div></div>

    <?php
      $raw        = $data['college_details'];
      ...
      if (!empty($paragraphs)) {
        ...
        echo '<p class="college-intro">' . nl2br(htmlspecialchars(trim($first))) . '</p>';
      }
    ?>
    ...
    <!-- Footer strip -->
    <div class="college-footer-strip">
